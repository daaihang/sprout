...
- This is not yet the final background scheduler. Phase 5 still needs retry policy, notification tap routing, delivered/dismissed status writeback, and polished settings UX.
