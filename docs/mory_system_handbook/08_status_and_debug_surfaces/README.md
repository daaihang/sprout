...
| Card Debug | Inspect four-layer card health, type catalog fixtures, masonry/density policy, object metrics, responsive board behavior, card states/actions, arrangement reports, and fixture stress labs. |
