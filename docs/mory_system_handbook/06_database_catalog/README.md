...
| `MemoryCardArrangementStore` | User-authored card layout for composer/detail/today desk rendering: visual recipe, order, stack/group, sticker attachments, nudge, rotation, and z-index | Product state/personal presentation |
