...
| `MemoryCardArrangementStore` | User-authored card layout for composer/detail/today desk rendering: content density, order, stack/group, sticker attachments, nudge, rotation, and z-index | Product state/personal presentation |
