...
- Card rendering is arrangement-driven: composer/detail/debug share the same content-kind render context, density policy, object metrics, and fixed-column masonry layout vocabulary.
