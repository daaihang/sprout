...
func (p *AnthropicProvider) SuggestNotificationIntent(ctx context.Context, req NotificationIntentSuggestionRequest, user UserContext) (NotificationIntentSuggestionResult, error) {
	if err := req.Validate(); err != nil {
